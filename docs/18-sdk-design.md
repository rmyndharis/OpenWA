...
| Method       | Signature                       | Description                                                                                                                                                                   |
| ------------ | ------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `rejectCall` | `rejectCall(sessionId, callId)` | Reject a ringing incoming call (`callId` comes from the `call.received` event). **Baileys only** in practice: a whatsapp-web.js session never learns a `callId`. **OPERATOR** |
...
| Method        | Signature                                           | Description                                                                                                                   |
| ------------- | --------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| `reject_call` | `reject_call(session_id, call_id) -> SuccessResult` | Reject a ringing incoming call. **Baileys only** in practice: a whatsapp-web.js session never learns a `callId`. **OPERATOR** |
...
| Method       | Signature                                              | Description                                                                                                                                                                   |
| ------------ | ------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `rejectCall` | `rejectCall(string $sessionId, string $callId): array` | Reject a ringing incoming call (404 when it is not found or no longer ringing). **Baileys only** in practice: a whatsapp-web.js session never learns a `callId`. **OPERATOR** |
