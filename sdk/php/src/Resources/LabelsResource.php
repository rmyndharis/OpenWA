...
class LabelsResource
{
    ...
    {
        return $this->http->request('GET', "/api/sessions/{$sessionId}/labels") ?? [];
    }

    /** @return array<string,mixed> */
    public function get(string $sessionId, string $labelId): array
    {
        return $this->http->request('GET', "/api/sessions/{$sessionId}/labels/{$labelId}");
    }

    /** @return array<int,array<string,mixed>> */
    public function forChat(string $sessionId, string $chatId): array
    {
        return $this->http->request('GET', "/api/sessions/{$sessionId}/labels/chat/{$chatId}") ?? [];
    }
    ...
    {
        return $this->http->request('POST', "/api/sessions/{$sessionId}/labels/chat/{$chatId}", [], $body);
    }
    ...
    {
        return $this->http->request('DELETE', "/api/sessions/{$sessionId}/labels/chat/{$chatId}/{$labelId}");
    }
}
